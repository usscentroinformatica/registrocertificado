      ...
      <div className="container mx-auto px-6 lg:px-20 relative z-10 py-12 lg:py-20">
        ...
        >
          ...
          <motion.div 
            ...
            className="flex items-center bg-white/80 backdrop-blur-sm px-4 py-2 rounded-full shadow-sm border border-gray-100/50 hover:shadow-md transition-shadow"
          ...
          <motion.div 
            variants={itemVariants}
            className="flex flex-col items-center bg-white/60 backdrop-blur-sm px-4 py-2 rounded-full shadow-sm border border-gray-100/50"
          ...
          >
            <div className="flex items-center gap-2">
              ...
              >
                <FaGlobeAmericas className="text-uss-blue text-xs md:text-sm" />
              </motion.div>
